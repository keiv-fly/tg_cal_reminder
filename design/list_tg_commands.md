...
| **/edit_event ⟨id event_line⟩** | **id** – event ID.<br/>**event_line** – same format as above | Updates an existing event. Warns if start is past. |
| **/list_all_events [from to]** | **from**/**to** – optional datetimes `YYYY-MM-DD HH:MM` | Lists events in the given range (UTC). |
